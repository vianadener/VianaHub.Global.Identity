# language: pt-BR
Funcionalidade: Validar a implementação do recurso App
  Como um time de plataforma
  Eu quero validar a implementação do recurso App
  Para que a funcionalidade possa ser enviada com segurança para produção

  Contexto:
    Dado que o recurso App já possui endpoints, serviço de aplicação, domínio, repositório e testes
  ...
  Cenário: Fluxo principal de validação
    Dado que a implementação do recurso App está disponível
